...
<body class="page">
    <div class="container">
        <div class="content oeuvres">
            <div class="grid">
                <div class="grid__item" data-size="400x663">
                    <a href="http://idata.over-blog.com/1/35/13/57/10-Mars/lackberg_LA-PRINCESSE-DES-GLACES.jpg" class="img-wrap"><img src="http://idata.over-blog.com/1/35/13/57/10-Mars/lackberg_LA-PRINCESSE-DES-GLACES.jpg" alt="img06" />
                ...
                <div class="grid__item" data-size="536x600">
                    <a href="http://3.bp.blogspot.com/_tdADlgbXDsY/TUX6kwfEmiI/AAAAAAAAAFI/JtsB3qOoE_o/s1600/El+pintor+de+batallas-1.jpg" class="img-wrap"><img src="http://3.bp.blogspot.com/_tdADlgbXDsY/TUX6kwfEmiI/AAAAAAAAAFI/JtsB3qOoE_o/s1600/El+pintor+de+batallas-1.jpg" alt="img07" />
                        <div class="description description--grid">
                            <h3>Silent Killer</h3>
